  ...
  },
  {
    ...
    features: [
      ...
      },
      {
        ...
        trigger: "Every Monday at 10:00 UTC",
        description: "Finds members with 0 war fame across the last 2 wars AND under 10 donations. Posts to whatever channel you configure — ideally a private #leadership channel, not public. Uses it as an early warning before kick decisions.",
        example: "😴 Inactive Members Alert\n💤 PlayerOne — 0 war fame · 2 donations\n💤 PlayerTwo — 0 war fame · 0 donations\n*Not even Usopp would make these excuses.*",
        slash: "/inactive",
      },
      {
        key: "kick_alert",
        label: "Kick Recommendation",
        trigger: "Every Monday at 11:00 UTC — only if candidates exist",
        description: "Identifies members with 0 fame in each of the last 2 wars. Posts a recommendation with their tag so you can look them up. Point this at a private admin channel — it's not meant for public view.",
        example: "🚨 Kick Recommendation — Admin Eyes Only\n⚠️ PlayerOne #ABC123 — 0 fame in last 2 wars\n⚠️ PlayerTwo #XYZ456 — 0 fame in last 2 wars\n*Review before the next war starts.*",
        slash: null,
      },
    ],
  },
